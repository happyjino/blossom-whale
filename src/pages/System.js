...
const System = () => {
  ...
  const point1 = "꽃피는 고래는 그린하우스에서 재배합니다. \n 일반적인 온실 형태에 스마트 제어 시스템이 결합되어 있기 때문에 체계적으로 작물을 관리할 수 있습니다."
  const point2 = "그린하우스는 자연광으로 길러 식물 공장에서 기른 채소보다 색이 선명하고 맛도 깊습니다. \n 물의 사용량 또한 토경재배 방식보다 현저히 적고, \n 에너지도 적게 사용하기 때문에 친환경적 재배 농법이라고 할 수 있습니다."
